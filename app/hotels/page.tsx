...
export default async function HotelsPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-2 max-w-2xl text-muted-foreground">Estimated typical room prices per night. Providers show current availability and final pricing.</p>
          ...
          <tbody className="divide-y">
            {list.map((d) => (
              <tr key={d.slug}>
                ...
                <td className="px-4 py-3 tabular-nums"><Money usd={d.hotelNightBudget} /></td>
                <td className="px-4 py-3 tabular-nums"><Money usd={d.hotelNightMid} /></td>
                <td className="px-4 py-3 tabular-nums"><Money usd={d.hotelNightLuxury} /></td>
              </tr>
            ))}
          </tbody>
        </table>
